...
function preload(){
    ...
    sherlockImg = loadAnimation("../images/transparent1.png", "../images/transparent2.png", "../images/transparent3.png", "../images/transparent4.png", "../images/transparent5.png" )
...
function draw(){
    ...
    if(character === 1){
        ...
        elseif(gameState === 4 && player.score < 5 )
        player.lives--;
        ...
        elseif(gameState === 7 && player.score < 10)
        player.lives--;
        ...
        elseif(gameState === 10 && player.score < 15)
        player.lives--;
...
if(character === 2){
        ...
        elseif(gameState === 13 && player.score < 20)
        player.lives--;
